...
export default function WebTransportPage() {
  ...
  const [streamMessage, setStreamMessage] = useState(
    '{"type": "message", "data": "Hello WebTransport!"}',
  );
  const [datagramMessage, setDatagramMessage] = useState(
  ...
  const addMessage = useCallback(
    (message: Omit<WebTransportMessage, 'id' | 'timestamp'>) => {
    ...
    try {
      ...
      if (certificateHash) {
        transportOptions.serverCertificateHashes = [
          {
            algorithm: 'sha-256',
            value: Uint8Array.from(atob(certificateHash), (c) =>
              c.charCodeAt(0),
            ),
          },
        ];
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={connect}
                  disabled={
                    isConnected || isConnecting || !checkWebTransportSupport()
                  }
                >
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <p>
                  Streams: {stats.streamsCreated} created, {stats.activeStreams}{' '}
                  active
                </p>
