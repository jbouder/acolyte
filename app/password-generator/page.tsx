...
import {
  ...
  calculateStrength,
  generatePassword,
  type PasswordOptions as Options,
  PASSWORD_PRESETS as PRESETS,
  type PasswordPreset as Preset,
} from '@/lib/password-utils';

// Re-exported so existing imports (and tests) of the page keep working.
